...
def parse_configuration():
    ...
    parser.add_argument("--meta_train_n_way", type=int, default=6)
    parser.add_argument("--meta_train_k_shot", type=int, default=1)
    parser.add_argument("--meta_train_query_count", type=int, default=450)
    ...
    parser.add_argument("--dataset_dir", type=str, default=
                        "../datasets/GasPipLine/gas_prepared_2-way1-shot_T6n450q_E2n450q_V8n120q")
    parser.add_argument("--model_x_dim0", type=int, default=1)
    parser.add_argument("--model_x_dim1", type=int, default=26)
    ...
    parser.add_argument("--meta_test_n_way", type=int, default=2)
    parser.add_argument("--meta_test_k_shot", type=int, default=1)
    parser.add_argument("--meta_test_query_count", type=int, default=450)
    parser.add_argument("--meta_test_episode_count", type=int, default=10)
