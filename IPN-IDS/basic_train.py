...
def parse_configuration():
    ...
    parser.add_argument("--meta_train_k_shot", type=int, default=10)
    parser.add_argument("--meta_train_query_count", type=int, default=470)
    ...
    parser.add_argument("--dataset_dir", type=str, default=
                        "datasets/CIC_IDS_2017/cic_ids_2017_prepared_4-way10-shot_T8n470q_E4n470q_V12n130q")
    ...
    parser.add_argument("--meta_test_k_shot", type=int, default=10)
    parser.add_argument("--meta_test_query_count", type=int, default=470)
