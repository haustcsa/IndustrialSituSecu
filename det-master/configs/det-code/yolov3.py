...
classes = ('crazing', 'inclusion', 'pitted_surface', 'scratches', 'patches',
           'rolled-in_scale')
...
data = dict(
    ...
    train=dict(
        type='VOCDataset',
        classes=('crazing', 'inclusion', 'pitted_surface', 'scratches',
                 'patches', 'rolled-in_scale'),
