...
class SparseRoIHead(CascadeRoIHead):
    ...
    def simple_test(self,
        ...
        for img_id in range(num_imgs):
            ...
            # filter_idx = torch.squeeze(
            #     scores_per_img[:, None] > self.test_cfg.score_thr)
            # det_bboxes.append(
            #                 torch.cat([bbox_pred_per_img, scores_per_img[:, None]], dim=1)[filter_idx])
            # det_labels.append(labels_per_img[filter_idx])
