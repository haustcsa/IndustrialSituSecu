...
Example:
    ...
    Use differential evolution to optimize anchors::
     python tools/analysis_tools/optimize_anchors.py configs/Amydet/yolov3.py --algorithm k-means --output-dir kmeans
python tools/analysis_tools/optimize_anchors.py configs/Amydet/yolov3.py --algorithm differential_evolution --output-dir kmeans
        python tools/analysis_tools/optimize_anchors.py ${CONFIG} \
